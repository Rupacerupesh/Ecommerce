...
Route::get('/home', 'LandingPageController@index')->name('landing-page');
...
Route::get('/retail', 'HomeController@retail')->name('Retail');
...
Route::post('/login/custom','Auth\LoginCotroller@custom')->name('login.custom');
