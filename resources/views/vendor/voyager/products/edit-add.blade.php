                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($allColors as $color)
                                    <li><label><input value="{{ $color->id }}" type="checkbox" name="color[]" style="margin-right: 5px;" {{ $colorsForProduct->contains($color) ? 'checked' : '' }}>{{ $color->name }}</label></li>
                                @endforeach
                                </ul>
                            </div> <!-- end form-group -->
...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            var wholesaleprice = $('input[name="wholesaleprice"').val();
            $('input[name="wholesaleprice"').val(wholesaleprice / 100);
        });
    </script>
@stop
