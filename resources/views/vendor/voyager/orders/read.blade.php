                            ...
                            <ul>
                                @foreach ($products as $product)
                                    <li style="margin-bottom: 10px">
                                        ...
                                        @if($dataTypeContent->wholesale)
                                        <div>Product Price: £{{  $product->wholesaleprice/100 }}</div>
                                        @else
                                        <div>Product Price: £{{  $product->price/100 }}</div>
                                        @endif

                                        @if($product->pivot->color)
                                        <div>Product Color: {{ $product->pivot->color }}</div>
                                        @endif
                                        <div>
                                    <img src="{{ productImage($product->image) }}" class="img-responsive">
                                        </div>
                                        <div>
                                            <a href="{{ route('shop.show', $product->slug) }}" class="btn btn-info">View Product</a>
