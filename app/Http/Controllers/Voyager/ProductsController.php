...
class ProductsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCategories', 'categoriesForProduct', 'allColors', 'colorsForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            $requestNew['wholesaleprice'] = $request->wholesaleprice * 100;
            ...
            $this->updateProductColors($request, $id);
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->ajax()) {
            ...
            $this->updateProductColors($request, $data->id);
    ...
    protected function updateProductColors(Request $request, $id)
    {
        if ($request->color) {
